        ...
        $.ajax({
            ...
            success:function(output) {
                ...
                if(output.success){
                    ...
                    $("#error-msg-span-prod").html(output.msg);
                    $("#success-msg-block-prod").hide();
            ...
            $.ajax({
                ...
                success:function(output) {
                    ...
                    if(output.success){
                        ...
                        $("#error-msg-span-prod").html(output.data);
                        $("#success-msg-block-prod").hide();
                        //$("#error-msg-block-prod").show();
                        showSuccessError('error-msg-block-prod');
                    }
    ...
    $.ajax({
        ...
        success:function(output) {
            ...
            if(output.subCatLevelExist==false){
                ...
                $("#error-msg-span").html(output.data);
                showSuccessError('error-msg-block');
                $("#success-msg-block").hide();
            }
        }
        ...
        $.ajax({
            ...
            success:function(output) {
                if(output.success){
                    ...
                    $("#btn_edit_1").removeAttr('disabled');
                    $("#error-msg-block").hide();
                    ...
                    showSuccessError('error-msg-block');
                    $("#success-msg-block").hide();
                    $("#btn_edit_1").attr('disabled','disabled');
                    return false;
                }
            }
        });
